...
class Submission(Base):
    """Maps orchestrator table `submissions` (read-only usage)."""
    ...
    # Denormalized slice of JobSubmissionEnvelope.workload (kind, name, image, gpu_count);
    # see contracts/job-submission/v1/schema.json WorkloadSpec and orchestrator repository.
